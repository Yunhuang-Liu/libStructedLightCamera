        ...
        if (x < cols && y < rows) {
            ...
            if (conditionImg_1_.ptr(y)[x] < 5.0) {
                ...
                for (int k = -120; k < 120; k++) {
                    ...
                    if (index_search<0 || index_search >cols - 1 || 
                        ...
                        conditionImg_1_.ptr(y)[index_search] < 5.0) {
                        continue;
                    }
            ...
            if (conditionImg_2_.ptr(y)[x] < 5.0) {
                ...
                for (int k = -120; k < 120; k++) {
                    ...
                    if (index_search<0 || index_search >cols - 1 || 
                        floor_K.ptr(y)[index_search] != K || 
                        conditionImg_2_.ptr(y)[index_search] < 5.0) {
                        continue;
                    }
        ...
        if (x < cols && y < rows) {
            ...
            if (conditionImg_3_.ptr(y)[x] < 5.0) {
                ...
                for (int k = -50; k < 50; k++) {
                    ...
                    if (index_search<0 || index_search >cols - 1 || 
                        floor_K.ptr(y)[index_search] != K || 
                        conditionImg_3_.ptr(y)[index_search] < 5.0) {
                        continue;
                    }
            ...
            if (conditionImg_4_.ptr(y)[x] < 5.0) {
                ...
                for (int k = -50; k < 50; k++) {
                    ...
                    if (index_search<0 || index_search >cols - 1 || 
                        floor_K.ptr(y)[index_search] != K || 
                        conditionImg_4_.ptr(y)[index_search] < 5.0) {
                        continue;
                    }
