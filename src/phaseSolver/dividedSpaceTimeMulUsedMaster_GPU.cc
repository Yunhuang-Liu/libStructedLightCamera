#include "../../include/phaseSolver/dividedSpaceTimeMulUsedMaster_GPU.h"
...
namespace sl {
    namespace phaseSolver {
        ...
        DividedSpaceTimeMulUsedMaster_GPU::DividedSpaceTimeMulUsedMaster_GPU(
                const cv::Mat &refImgWhite_, const dim3 block_) : refImgWhite_device(refImgWhite_), block(block_) {
