...
public:
    ...
    // @brief 结构光相机设置参数
    struct SLCameraSet{
        SLCameraSet() : chipCore(ChipControlCore::DLPC3479), cameraSet(sl::device::CameraControl::CameraUsedState::LeftGrayRightGray){}
     ...
     */
    StructedLightCamera(const sl::tool::Info& infoCalibraion, const AlgorithmType algorithmType = AlgorithmType::FourStepSixGrayCode, const AcceleratedMethod acceleratedMethod = AcceleratedMethod::CPU,const SLCameraSet cameraSet = SLCameraSet(),
