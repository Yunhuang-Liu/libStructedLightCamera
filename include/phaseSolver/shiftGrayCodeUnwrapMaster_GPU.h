/**
 * @file shiftGrayCodeUnwrapMaster_GPU.h
...
#ifndef PHASESOLVER_SHIFTGRAYCODEMASTER_GPU_H_
#define PHASESOLVER_SHIFTGRAYCODEMASTER_GPU_H_
...
namespace sl {
    ...
    namespace phaseSolver {
        ...
        public:
             ...
             */
            ShiftGrayCodeUnwrapMaster_GPU(const dim3 block = dim3(32, 8),
                                          const cv::Mat &refImgWhite_ = cv::Mat(1, 1, CV_32FC1));
            /**
             * @brief 构造函数
             * @param imgs 输入，原始图片
             ...
             * @param block 输入，Block尺寸
             */
            ShiftGrayCodeUnwrapMaster_GPU(std::vector<cv::Mat> &imgs,
                                          const cv::Mat &refImgWhite = cv::Mat(1, 1, CV_32FC1),
...
#endif // PHASESOLVER_SHIFTGRAYCODEMASTER_GPU_H_
