 ...
 *
 */
#ifndef PHASESOLVER_FOURSTEPSIXGRAYCODEMASTER_CPU_H_
#define PHASESOLVER_FOURSTEPSIXGRAYCODEMASTER_CPU_H_
    ...
    namespace phaseSolver {
        ...
        public:
            ...
            FourStepSixGrayCodeMaster_CPU(
                    const cv::Mat &refImg = cv::Mat(0, 0, CV_32FC1),
             ...
             * @param threads 输入，线程数
             */
            FourStepSixGrayCodeMaster_CPU(std::vector<cv::Mat> &imgs,
                                          const cv::Mat &refImg = cv::Mat(0, 0, CV_32FC1),
                                          const int threads = 16);
            /**
             * @brief 析构函数
        ...
        private:
             ...
             */
            void dataInit_Thread_SIMD(const int rows, const int cols,
             ...
             */
            void mutiplyThreadUnwrap(const int rows, const int cols,
                                     const cv::Point2i region,
             ...
             * @param wrapImg 输入输出，包裹相位
             */
            void SIMD_WrapImg(const cv::Mat &lhs,
                              const cv::Mat &rhs,
                              const cv::Point2i &region,
                              cv::Mat &wrapImg);
...
#endif // PHASESOLVER_FOURSTEPSIXGRAYCODEMASTER_CPU_H_
